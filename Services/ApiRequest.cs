    ...
    public static class ApiRequest
    {
            ...
            int page)
        {
            try
            {
                ...
                form.Add(new StringContent(coordX.ToString("F2", CultureInfo.InvariantCulture)), "CoordinateX");
                form.Add(new StringContent(coordY.ToString("F2", CultureInfo.InvariantCulture)), "CoordinateY");
